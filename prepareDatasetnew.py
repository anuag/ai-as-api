...
# in
datasetInputFile = 'training/dataset/clickbait-dataset.csv'
# out
trainingDumpFile = 'training/prepared_dataset/clickbait_training_data.pickle'
...
if __name__ == '__main__':
    ...
    #
    labelLegend = {'clickbait': 0, 'nonclickbait': 1}
